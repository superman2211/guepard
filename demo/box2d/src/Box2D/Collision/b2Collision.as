...
package Box2D.Collision
{
	...
	public class b2Collision
	{
		...
		private static var s_edgeAO:Vector.<int> = new Vector.<int>();
		private static var s_edgeBO:Vector.<int> = new Vector.<int>();
		...
		{
			var r:Vector.<ClipVertex> = new Vector.<ClipVertex>();
			r[0] = new ClipVertex();
			r[1] = new ClipVertex();
			return r;
		}
